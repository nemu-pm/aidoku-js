...
// ============================================================================
// HTTP Bridge Types (consumer must implement)
// ============================================================================

/**
 * HTTP request to be made by the runtime.
 * Consumer's HttpBridge.request() receives this.
 */
...
/**
 * HTTP response from the bridge.
 * Consumer's HttpBridge.request() returns this.
 */
...
/**
 * HTTP bridge interface - consumer must implement this.
 * IMPORTANT: request() must be SYNCHRONOUS as WASM calls are blocking.
 */
...
// The runtime converts these to the appropriate format for each ABI
...
/** Runtime mode detection for WASM sources */
export const RuntimeMode = {
  /** Legacy Swift-era ABI */
  Legacy: "legacy",
  /** Modern aidoku-rs ABI */
  AidokuRs: "aidoku-rs",
} as const;
...
/** Modified image request with headers */
